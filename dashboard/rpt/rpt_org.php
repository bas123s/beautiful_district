<?php
$title = "สรุปผลเกณฑ์การประเมิน 5. การตรวจประเมินจากหน่วยงานภายนอก “ภาคีเครือข่าย” ";
...
$chart = number_format((float) ($s1 * 10), 2, '.', '') . "," . number_format((float) ($s2 * 10), 2, '.', '') . "," . number_format((float) ($s3 * 10), 2, '.', '');
?>
    ...
    <div class="container mx-auto px-4  relative">
        <div class="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-1 gap-[30px]">
            <div class="card container  " style="  text-align: center;   ">
                            ...
                            <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-[30px]">
                                ...
                                <div class="p-5 flex items-center">
                                    ...
                                    <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                                        <span class="text-slate-400 font-semibold block" style="text-align: left"> 1. ศูนย์ราชการสะดวก</span>
                                ...
                                <div class="p-5 flex items-center">
                                    ...
                                    <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                                        <span class="text-slate-400 font-semibold block" style="text-align: left"> 2. การประเมิน ITA : การประเมินคุณธรรมและความโปร่งใสในการดำเนินงานของหน่วยงานภาครัฐ</span>
                                        <span class="flex items-center justify-between mt-1">
                                            <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
                                ...
                                <div class="p-5 flex items-center">
                                    ...
                                    <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                                        <span class="text-slate-400 font-semibold block" style="text-align: left">3. อำเภอคุณธรรม</span>
                                        <span class="flex items-center justify-between mt-1">
                                            <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
              ...
              <!--              <a href="rpt_org_province.php" class="mt-5 py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md" style="text-align: center"><span>ดูรายละเอียด</span></a>-->
                            <!--</div>-->
...
<script>
    var options = {
        series: [{
                name: 'การตรวจประเมินจากหน่วยงานภายนอก',
                data: [<?= (string) $chart ?>]
            }],
        chart: {
            height: 350,
        ...
        xaxis: {
            ...
            categories: ['ศูนย์ราชการสะดวก', 'ความโปร่งใส', 'อำเภอคุณธรรม'],
            tickPlacement: 'on'
        },
        yaxis: {
            title: {
                text: 'การตรวจประเมินจากหน่วยงานภายนอก',
            },
        },
        fill: {
            type: 'gradient',
