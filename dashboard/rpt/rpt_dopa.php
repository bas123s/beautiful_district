<?php
$title = "สรุปผลเกณฑ์การประเมิน 1. การขับเคลื่อนภารกิจของกระทรวงมหาดไทย “บำบัดทุกข์ บำรุงสุข” ";
...
<section class="relative  md:py-24 py-16">
              ...
              <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-[30px]">
                ...
                <div class="p-5 flex items-center">
                  ...
                  <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                    <span class="text-slate-400 font-semibold block" style="text-align: left"> 1. โครงการอำเภอบำบัดทุกข์ บำรุงสุข แบบบูรณาการอย่างยั่งยืน</span>
                ...
                <div class="p-5 flex items-center">
                  ...
                  <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                    <span class="text-slate-400 font-semibold block" style="text-align: left"> 2. โครงการหนึ่งตำบล หนึ่งหมู่บ้านยั่งยืน (Sustainable Village)</span>
                    <span class="flex items-center justify-between mt-1">
                      <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
                ...
                <div class="p-5 flex items-center">
                  ...
                  <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                    <span class="text-slate-400 font-semibold block" style="text-align: left">3. โครงการพัฒนาระบบการพิสูจน์และยืนยันตัวตนทางดิจิทัล
                      (DOPA-Digital ID)เพื่อสร้างต้นแบบและนวัตกรรมใหม่
                      ในการพิสูจน์และยืนยันตัวตนทางดิจิทัลของประเทศรองรับ
                      การใช้งานบริการภาครัฐ (THAID)</span>
                    <span class="flex items-center justify-between mt-1">
                      <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
                ...
                <div class="p-5 flex items-center">
                  ...
                  <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                    <span class="text-slate-400 font-semibold block" style="text-align: left"> 4. การป้องกัน ปราบปราม และแก้ไขปัญหายาเสพติด</span>
                    <span class="flex items-center justify-between mt-1">
                      <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
                ...
                <div class="p-5 flex items-center">
                  ...
                  <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                    <span class="text-slate-400 font-semibold block" style="text-align: left"> 5. การแก้ไขปัญหาเรื่องร้องเรียนร้องทุกข์ </span>
                    <span class="flex items-center justify-between mt-1">
                      <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
  ...
  <!--<a href="rpt_dopa_province.php" class="mt-5 py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md" style="text-align: center"><span>ดูรายละเอียด</span></a>-->
              <!--</div>-->
...
<script>
  var options = {
    ...
    xaxis: {
      ...
      categories: ['อำเภอบำบัดทุกข์ฯ', 'หนึ่งตำบล หนึ่งหมู่บ้านฯ', 'ยืนยันตัวตนทางดิจิทัล', 'แก้ไขปัญหายาเสพติด', 'ร้องเรียนร้องทุกข์'],
      tickPlacement: 'on'
    },
    yaxis: {
      title: {
        text: 'โครงการอำเภอสวยงาม',
      },
    },
    fill: {
      type: 'gradient',
