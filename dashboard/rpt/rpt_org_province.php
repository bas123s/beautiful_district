...
$sql = "SELECT * FROM `view_assessment_org_p` ;";
              ...
              <tbody>
                ...
                foreach (@$data as $key => $value) {
                  ...
                  <tr>
                    <td><?= $i++; ?></td>
                    <!--<td>< ?= @$value['pcode']; ?></td>-->
                    <td><a href="rpt_org_amp.php?pcode=<?= $value['pcode']; ?>" class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded" style="width: 100%"><?= @$value['pname']; ?></a><input name="id[<?= @$value['id']; ?>]" hidden value="1"></td>
                    <!--<td>< ?= @$value['acode']; ?> </td>-->
