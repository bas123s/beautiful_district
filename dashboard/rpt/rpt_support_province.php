...
$sql = "SELECT * FROM `view_assessment_support_p` ;";
            ...
            <table id="example" class=" " style="width: 100%;text-align: center; border: #000000;">
              <thead>
                <tr>
                  ...
                  <th>บ้านนี้มีรักฯ</th>
                  <th>การส่งเสริมฯ</th>
                  <th>ผ้าไทยใส่ให้สนุก</th>
                  <th>ครอบครัวมหาดไทยฯ</th>
                  <th>ช่วยเหลือผู้ยากไร้ฯ</th>
              ...
              <tbody>
                ...
                foreach (@$data as $key => $value) {
                  ...
                  <tr>
                    <td><?= $i++; ?>  </td>
                    <!--<td>< ?= @$value['pcode']; ?></td>-->
                    <td><a href="rpt_support_amp.php?pcode=<?= $value['pcode']; ?>" class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded" style="width: 100%"><?= @$value['pname']; ?></a><input name="id[<?= @$value['id']; ?>]" hidden value="1"></td>
                    <!--<td>< ?= @$value['acode']; ?> </td>-->
                    <!--<td>< ?= @$value['aname']; ?><input name="id[< ?= @$value['id']; ?>]" hidden value="1"></td>-->
                    <!--<td>20</td>-->
                    <td class="px-4 py-2 text-right"><?= @$value['home']; ?></td>
                    <!--<td>20</td>-->
                    <td class="px-4 py-2 text-right"><?= @$value['hygiene']; ?></td>
                    <!--<td>20</td>-->
                    <td class="px-4 py-2 text-right"><?= @$value['clothes']; ?></td>
                    <!--<td>20</td>-->
                    <td class="px-4 py-2 text-right"><?= @$value['family']; ?></td>
                    <!--<td>20</td>-->
