                    ...
                    <div class="card-body md:text-xl text-xl font-medium text-center">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 md:grid-cols-2 gap-[30px]">
                            ...
                            <div class="p-5 flex items-center">
                                <span
                                    class="flex justify-center items-center rounded-md h-14 w-14 min-w-[56px] text-indigo-600">
                            ...
                            <div class="p-5 flex items-center">
                                ...
                                <div class="ms-3bg-indigo-600  ps-5 " style="width:100%;">
                                    <span class="text-slate-400 font-semibold block" style="text-align: left">3.
                                        ผ้าไทยใส่ให้สนุก</span>
                                    <span class="flex items-center justify-between mt-1">
                                        <span class="text-slate-400 ">เฉลี่ยทั้งประเทศ</span>
                                        <span class="text-xl font-semibold  text-indigo-600">
                        ...
                        <!--              <a href="rpt_support_province.php" class="mt-5 py-2 px-5 inline-block font-semibold tracking-wide border align-middle duration-500 text-base text-center bg-indigo-600 hover:bg-indigo-700 border-indigo-600 hover:border-indigo-700 text-white rounded-md" style="text-align: center"><span>ดูรายละเอียด</span></a>-->
                        <!--</div>-->
...
<script>
    var options = {
        ...
        xaxis: {
            ...
            categories: ['ปลูกผักกินเอง', 'เด็กและแม่', 'ผ้าไทย', 'สิ่งแวดล้อม', 'ผู้ยากไร้'],
            tickPlacement: 'on'
        },
        yaxis: {
            title: {
                text: 'สมาคมแม่บ้านมหาดไทย',
            },
        },
        fill: {
            type: 'gradient',
