<?php
$title = "สรุปผลเกณฑ์การประเมิน  1. โครงการอำเภอบำบัดทุกข์ บำรุงสุข แบบบูรณาการอย่างยั่งยืน ";
...
$sql = "SELECT * FROM `view_assessment_dopa_p` ;";
            ...
            <table id="example" class=" " style="width: 100%;text-align: center; border: #000000;">
              <thead>
                <tr>
                  ...
                  <!--<th>รหัสอำเภอ</th>-->
                  <!--<th>อำเภอ</th>-->
                  <th>อำเภอบำบัดทุกข์ฯ</th>
                  <th>หนึ่งตำบล หนึ่งหมู่บ้านฯ</th>
                  <th>พิสูจน์และยืนยันตัวตนฯ</th>
                  <th>แก้ไขปัญหายาเสพติด</th>
                  <th>ร้องเรียนร้องทุกข์</th>
              ...
              <tbody>
                ...
                foreach (@$data as $key => $value) {
                  ...
                  <tr>
                    <td><?= $i++; ?>  </td>
                    <!--<td>< ?= @$value['pcode']; ?></td>-->
                    <td><a href="rpt_dopa_amp.php?pcode=<?= $value['pcode']; ?>" class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded" style="width: 100%"><?= @$value['pname']; ?></a><input name="id[<?= @$value['id']; ?>]" hidden value="1"></td>
                    <!--<td>< ?= @$value['acode']; ?> </td>-->
