...
<!--Note: Cookies Js including in plugins.init.js (path like; ../../require/partials/assets/js/plugins.init.js) and Cookies css including in _helper.scss (path like; scss/_helper.scss)-->
<!-- End Cookie Popup -->