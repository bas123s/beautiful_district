    ...
    <div class="container relative">
        ...
        <ul class="buy-button list-none mb-0">
            ...
            <li class="inline ps-1 mb-0">
                <a href="https://1.envato.market/techwind" target="_blank" class="h-9 w-9 inline-flex items-center justify-center tracking-wide align-middle transition duration-500 ease-in-out text-base text-center rounded-full bg-indigo-600 hover:bg-indigo-700 border border-indigo-600 hover:border-indigo-700 text-white"><i data-feather="shopping-cart" class="h-4 w-4"></i></a>
            </li>
        </ul>
        <!--Login button End-->
            ...
            <ul class="navigation-menu">
                    ...
                    <ul class="submenu megamenu">
                        <li>
                            <ul>
                                ...
                                <li><a href="javascript:void(0)" class="sub-menu-item">AI Tools <span class="bg-red-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">Comingsoon</span></a></li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="javascript:void(0)" class="sub-menu-item">Travels <span class="bg-red-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">Comingsoon</span></a></li>
                                <li><a href="index-cafe.html" class="sub-menu-item">Cafe </a></li>
                        ...
                        <li>
                            <ul>
                                ...
                                <li><a href="javascript:void(0)" class="sub-menu-item">Podcasts <span class="bg-red-600 inline-block text-white text-[10px] font-bold px-2.5 py-0.5 rounded h-5 ms-1">Comingsoon</span></a></li>
                ...
                <li class="has-submenu parent-parent-menu-item">
                    ...
                    <ul class="submenu">
                        ...
                        <li class="has-submenu parent-menu-item"><a href="javascript:void(0)"> NFT Market </a><span class="submenu-arrow"></span></a><span class="submenu-arrow"></span>
                            <ul class="submenu">
