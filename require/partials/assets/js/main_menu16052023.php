                ...
                <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
                    ...
                    <div class="main-menu-content">
                        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                            ...
                            <li class=" nav-item"><a class="d-flex align-items-center" href="../../app/main/"><i
                                        class="fa-solid fa-home"></i><span class="menu-title text-truncate"
                                        data-i18n="Dashboards">ขอพระราชทานเครื่องราชย์</span></a>
                            </li>

                            <li class=" nav-item"><a class="d-flex align-items-center" onclick="medal(<?php echo $user['pid']; ?>)" ><i
                                        class="fa-solid fa-home"></i><span class="menu-title text-truncate"
                                        data-i18n="Dashboards">เหรียญจักรพรรดิมาลา</span></a>
                            </li>


                            <!--                             /*  จังหวัด /สล */-->
                            <?php
                            if (in_array($user["privilege"], ["7", "8", "9"], TRUE)) {
                                ?>
                                <li class=" nav-item"><a class="d-flex align-items-center" href="../../app/main/"><i
                                            class="fa-solid fa-home"></i><span class="menu-title text-truncate"
                                            data-i18n="Dashboards">เหรียญพิทักษ์เสรีชน</span></a>
                                </li>
                            <?php } ?>
                            <!--                             /*  จังหวัด /สล */-->
                            <?php if ($user["privilege"] === "8" || $user["privilege"] === "9") { ?>
                                <li class=" nav-item"><a class="d-flex align-items-center" href="../../app/main/"><i
                                            class="fa-solid fa-home"></i><span class="menu-title text-truncate"
                                            data-i18n="Dashboards">นำเข้าไฟล์</span></a>
                                </li>
                                <li class=" nav-item"><a class="d-flex align-items-center" href="../../app/main/"><i
                                            class="fa-solid fa-home"></i><span class="menu-title text-truncate"
                                            data-i18n="Dashboards">ประมวลรายชื่อ</span></a>
                                </li>
                            <?php } ?>
