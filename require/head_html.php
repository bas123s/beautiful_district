...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <body  style="background-image: url('../../core/user/assets/images/nft/hero.png');     background-size: 100% 100%;" class="pace-done horizontal-layout horizontal-menu navbar-floating footer-static menu-expanded" data-open="click" data-menu="vertical-menu-modern" data-col="">

        <?php require '../../require/main_menu.php'; ?>