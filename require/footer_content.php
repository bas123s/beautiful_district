...
<footer class="footer footer-static footer-light text-center">
    <div class="footer-title text-primary lead">
        <!-- <i class="fa-solid fa-copyright"></i> สำนักงานเลขานุการ กรมการปกครอง<br> -->
        <i class="fa-solid fa-copyright"></i> ศูนย์สารสนเทศเพื่อการบริหารงานปกครอง กรมการปกครอง กระทรวงมหาดไทย
    </div>
</footer>
