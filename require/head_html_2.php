...
<link href="../../require/partials/assets/fonts/googlefont.css" rel="stylesheet">
    ...
    require '../../require/partials/navbar/navbar.php'
        ?> 
        <!-- Start Hero -->
        <section class="relative table w-full py-36 lg:py-44 bg-no-repeat bg-center bg-cover" style ="background-image: url('../../require/partials/assets/images/GUN.jpg') !important;">
            <div class="absolute inset-0 bg-black opacity-50"></div>
            <div class="container relative">
                <div class="grid grid-cols-1 pb-8 text-center mt-10">
                    <h5 class="text-white/50 text-lg font-medium"> </h5>
                    <h3 class="mt-2 md:text-4xl text-3xl md:leading-normal leading-normal font-medium text-white">ระบบอาวุธปืนลูกซอง และเครื่องกระสุนปืนลูกซอง <br>ตามโครงการอาสาพัฒนาและป้องกันตนเองแห่งชาติ (อพป.)</h3>
                </div><!--end grid-->
            </div><!--end container-->
