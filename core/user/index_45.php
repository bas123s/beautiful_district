<html>
  ...
  <?php
  $title = "หน้าหลัก";
$module_name = "รายงานการแจ้งการควบคุมตัว";
  require '../../require/new_header.php';
require '../../require/new_main_menu.php';
?>
                ...
                <div class="flex flex-wrap -mx-3">
                  <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div class="flex flex-col h-full">
                      <p class="pt-2 mb-1 font-semibold">ข่าวประชาสัมพันธ์</p>
                      <h5 class="font-bold">ตรวจสอบข้อมูลเครื่องราชอิสริยาภรณ์</h5>
                      <p class="mb-12">จากเว็บไซต์สำนักเลขาธิการคณะรัฐมนตรี</p>
            ...
            <div class="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
              <div class="relative h-full overflow-hidden bg-cover rounded-xl" style="background-image: url('../assets/img/ivancik.jpg')">
                ...
                <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                  <h5 class="pt-2 mb-6 font-bold text-white">ข่าวประชาสัมพันธ์</h5>
                  <p class="text-white">ค้นหารายชื่อ ผู้ได้รับเครื่องราชอิสริยาภรณ์ ปี 2565. ชั้นต่ำกว่าสายสะพายปี 2565 ค้นหาโดยการกด CTRL+F แล้วพิมพ์ชื่อที่ต้องการค้นหา</p>
                  <a class="mt-auto mb-0 font-semibold leading-normal text-white group text-sm" href="javascript:;">
                  ค้นหารายชื่อ ผู้ได้รับเครื่องราชอิสริยาภรณ์ ปี 2565
                    <i class="fas fa-arrow-right ease-bounce text-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200"></i>
                  </a>
                </div>
              </div>
        ...
        <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div class="border-black/12.5 shadow-soft-xl relative flex h-full min-w-0 flex-col break-words rounded-2xl border-0 border-solid bg-white bg-clip-border p-4">
              <div class="relative h-full overflow-hidden bg-cover rounded-xl" style="background-image: url('../assets/img/ivancik.jpg')">
                ...
                <div class="relative z-10 flex flex-col flex-auto h-full p-4">
                  <h5 class="pt-2 mb-6 font-bold text-white">ข่าวประชาสัมพันธ์</h5>
                  <p class="text-white">ค้นหารายชื่อ ผู้ได้รับเครื่องราชอิสริยาภรณ์ ปี 2564. ชั้นต่ำกว่าสายสะพายปี 2564 ค้นหาโดยการกด CTRL+F แล้วพิมพ์ชื่อที่ต้องการค้นหา</p>
                  <a class="mt-auto mb-0 font-semibold leading-normal text-white group text-sm" href="javascript:;">
                  ค้นหารายชื่อ ผู้ได้รับเครื่องราชอิสริยาภรณ์ ปี 2564
                    <i class="fas fa-arrow-right ease-bounce text-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200"></i>
                  </a>
                </div>
              </div>
              ...
              <div class="flex-auto p-4">
                <div class="flex flex-wrap -mx-3">
                  <div class="max-w-full px-3 lg:w-1/2 lg:flex-none">
                    <div class="flex flex-col h-full">
                      <p class="pt-2 mb-1 font-semibold">ข่าวประชาสัมพันธ์</p>
                      <h5 class="font-bold">ค้นหารายชื่อ ผู้ได้รับเครื่องราชอิสริยาภรณ์ ปี 2565.</h5>
                      <p class="mb-12">ชั้นต่ำกว่าสายสะพายปี 2565 ค้นหาโดยการกด CTRL+F แล้วพิมพ์ชื่อที่ต้องการค้นหา</p>
                      <a class="mt-auto mb-0 font-semibold leading-normal text-sm group text-slate-500" href="javascript:;">
                      ค้นหารายชื่อ 
                        <i class="fas fa-arrow-right ease-bounce text-sm group-hover:translate-x-1.25 ml-1 leading-normal transition-all duration-200"></i>
                      </a>
              ...
              <div class="flex-auto p-4">
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      <p class="mb-0 font-sans font-semibold leading-normal text-sm">คู่มือและขั้นตอนการใช้งาน</p>
                      <h5 class="mb-0 font-bold">
                        ผู้ใช้งาน
                        <span class="leading-normal text-md font-weight-bolder text-lime-500">ระดับบุคคล</span>
                      </h5>
                    </div>
                  </div>
                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    <div>
                      ...
                      <h5 class="mb-0 font-bold">
                        ผู้ใช้งาน
                        <span class="leading-normal text-md font-weight-bolder text-lime-500">ระดับอำเภอ</span>
                      </h5>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
                ...
                <div class="flex flex-row -mx-3">
                  <div class="flex-none w-2/3 max-w-full px-3">
                    ...
                    <p class="mb-0 font-sans font-semibold leading-normal text-sm">คู่มือและขั้นตอนการใช้งาน</p>
                      <h5 class="mb-0 font-bold">
                        ผู้ใช้งาน
                        <span class="leading-normal text-md font-weight-bolder text-lime-500">ระดับจังหวัด</span>
                      </h5>
                    </div>
                  </div>
                  <div class="px-3 text-right basis-1/3">
  ...
  <?php
  require '../../require/new_footer.php';
