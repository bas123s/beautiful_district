...
<head>
  ...
  <title>ระบบเครื่องราชอิสริยาภรณ์</title>
            ...
            <div class="card mb-0">
              <div class="card-body">
                <a href="index.html" class="brand-logo">
                  <img src="../../require/images/logo_500x500.png" class="mb-2" alt="Avatar"
                    style="width:100%; max-width:100px;">
                  <img src="../../require/images/logo_2.png" class="mb-2" alt="Avatar"
                    style="width:100%; max-width:100px;">
                </a>

                <h2 class="text-center fw-bolder mb-1">ระบบเครื่องราชอิสริยาภรณ์</h2>
             

                <!--<form class="auth-login-form mt-2" action="index.html" method="POST">-->
                <form id='form1' class="auth-login-form mt-2" action="password.php" method="POST">
                  <div class="mb-1">
                    <label for="username" class="form-label fw-bolder">ชื่อผู้ใช้งาน</label>
                    <input type="text" class="form-control" id="username" name="username" placeholder="กรอกรหัสหน่วยงาน"
                      aria-describedby="กรอกเลขบัตรประจำตัวประชาชน 13 หลัก" tabindex="1" autofocus />
                  </div>
                ...
                <footer class="blockquote-footer text-end">
                  <i class="fa-solid fa-copyright"></i> ศูนย์สารสนเทศเพื่อการบริหารงานปกครอง กรมการปกครอง <br>
                  <cite title="Source Title">ติดต่อสอบถามเกี่ยวกับการใช้งานระบบ  <span class="text-primary">Line ID : @thaiqm </span> </cite><br>
                  <cite title="Source Title">หรือ หากพบอุปสรรคในการดำเนินงานติดต่อ  <br><span class="text-primary"><img src="dopa_arrest.jpg" width="100px"></span> </cite>
                </footer>
