...
$sql = "SELECT * FROM `beautiful_district`.`assessment_services` WHERE `acode` = '" . @($_REQUEST['acode']) . "'";
        ...
        <body>
            <div>
                <div>
                    ...
                    <h4 style="font-size: 16pt; text-align: center; font:bold"> หัวข้อการประเมินหลัก ข้อ 4 การให้การบริการประชาชนและเป็นที่พึ่งให้ประชาชน</h4>
                    ...
                    <table >
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td style="width: 70%;text-align: left; padding-left: 10px;" >ด้านสถานที่</td>
                            ...
                            <tr>
                                <td>3 </td>
                                <td style="text-align: left; padding-left: 10px;" >ด้านการให้บริการ</td>

                                <td class="px-4 py-2 text-right"> <?= @$value['s3']; ?></td>
                            </tr>
                            <tr>
                                <td>4 </td>
                                <td style="text-align: left; padding-left: 10px;" >บุคลากร</td>
                                <td>20</td>
                ...
                <div style=" text-align: center; width: 100%;font-size: 16pt;"><b>(..................................................)<br><br>
                        ...
                        ผู้ประเมิน</b></div>
                <div class="bottom-content" style="position: absolute;bottom: 0;">
