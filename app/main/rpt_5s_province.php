<?php
$title = "สรุปผลเกณฑ์การประเมิน  3. การจัดการความเรียบร้อยของที่ทำการปกครองอำเภอ (5 ส.) 100 คะแนน และการอำนวยความสะดวกแก่ประชาชน ";
...
$sql = "SELECT * FROM `view_assessment_5s_p` ;";
                            ...
                            <tbody>
                                ...
                                foreach (@$data as $key => $value) {
                                    ...
                                    <tr>
                                        <td><?= $i++; ?>  </td>
                                        <!--<td>< ?= @$value['pcode']; ?></td>-->
                                        <td><a href="rpt_5s_amp.php?pcode=<?= $value['pcode']; ?>" class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded" style="width: 100%"><?= @$value['pname']; ?></a><input name="id[<?= @$value['id']; ?>]" hidden value="1"></td>
                                        <!--<td>< ?= @$value['acode']; ?> </td>-->
                                        ...
                                        <!--<td>20</td>-->
                                        <td class="px-4 py-2 text-right"><?= @$value['s4']; ?></td>
                                        <!--<td>20</td>-->
                                        <td class="px-4 py-2 text-right"><?= @$value['s5']; ?></td>
                                        <td><a href="5s_province_pdf.php?pcode=<?= @$value['pcode']; ?>&aname=<?= @$value['aname']; ?>&pname=<?= @$value['pname']; ?>"<button type="submit" class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">พิมพ์แบบประเมิน</button></a></td>
                                    </tr>
                                <?php } ?>
