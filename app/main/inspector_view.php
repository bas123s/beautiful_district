                        ...
                        <div id="accordion-collapse" data-accordion="collapse">
                            ...
                            <div id="accordion-collapse-body-1" class="hidden"
                                ...
                                <div
                                    ...
                                    <span class="text-red-500">ด้านหน้าประตูทางเข้าอาคารที่ว่าการอำเภอ</span>
                                    <div
                                        class="col-span-full text-center text-xl  grid md:grid-cols-2 grid-cols-2 justify-center mx-auto mt-8">
...
ค่าธรรมเนียม แผนผังสำนักงาน และอื่น ๆ
                            ...
                            <div id="accordion-collapse-body-8" class="hidden"
                                ...
                                <span class="text-red-500"> อื่น ๆ (ถ้ามี) เช่น ห้องที่ทำงานอื่น ห้องประชุม ลานอเนกประสงค์ แปลงผักสวนครัวต้นแบบ ถังขยะเปียก
ลดโลกร้อน ฯลฯ</span>
                                    <div
                                        class="col-span-full text-center text-xl  grid md:grid-cols-2 grid-cols-2 justify-center mx-auto mt-8">
