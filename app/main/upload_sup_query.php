...
$mc->table_name = "files_support"; //กำหนดชื่อตารางที่จะบันทึกข้อมูล
...
foreach ($_FILES as $key => $value) {
	if($value['name']!=""){
	    ...
	    $fileDestination = "../../uploads/upload_sup/".$fileNameNew;
...
$link = "upload_sup.php?a=บันทึกสำเร็จ&pcode=" . $_POST['pcode'] . "&acode=" . $_POST['acode'] . "";
