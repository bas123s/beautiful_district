...
$mc->table_name = "inspector"; //กำหนดชื่อตารางที่จะบันทึกข้อมูล
...
foreach ($_FILES as $key => $value) {
	if($value['name']!=""){
	    ...
	    $fileDestination = "../../uploads/upload_pic/".$fileNameNew;
...
$link = "inspector.php?a=บันทึกสำเร็จ&pcode=" . $_POST['pcode'] . "&aname=" . $_POST['aname'] . "";
