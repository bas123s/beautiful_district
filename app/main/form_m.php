...
บ้านนี้มีรัก ปลูกผักกินเอง 
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>2. อำเภอมีการลงพื้นที่ตรวจเยี่ยม / ให้กำลังใจ / 
เข้าร่วมกิจกรรมที่เกี่ยวข้องกับโครงการ
ทางนี้มีผล ผู้คนรักกัน 
                                            ...
                                            <td>
                                                <div class="flex item-left mb-4">
                                                    <input type="radio" value="0" <?php if ($data['food_2'] == "0") {
                                                        echo "checked";
                                                    } ?> name="food_2" id="food_2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">ไม่มีการตรวจเยี่ยม/ลงพื้นท</label>
                                                </div>
                                                <div class="flex item-left">
                                                    <input type="radio" value="5" <?php if ($data['food_2'] == "5") {
                                                        echo "checked";
                                                    } ?> name="food_2" id="food_2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">ตรวจเยี่ยม/ลงพื้นที่ 1-5 ครั้ง
                                                ...
                                                <div class="flex item-left">
                                                    <input type="radio" value="10" <?php if ($data['food_2'] == "10") {
                                                        echo "checked";
                                                    } ?> name="food_2" id="food_2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">ตรวจเยี่ยม/ลงพื้นที่ 6-10 ครั้ง
                                                ...
                                                <div class="flex item-left">
                                                    <input type="radio" value="15" <?php if ($data['food_2'] == "15") {
                                                        echo "checked";
                                                    } ?> name="food_2" id="food_2" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">ตรวจเยี่ยม/ลงพื้นที่ 10 ครั้งขึ้นไป
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>3.อำเภอดำเนินการขับเคลื่อนโครงการบ้านนี้มีรัก 
ปลูกผักกินเอง/ทางนี้มีผล ผู้คนรักกัน
                                            ...
                                            <td>
                                                <div class="flex item-left mb-4">
                                                    <input type="radio" value="10" <?php if ($data['food_3'] == "10") {
                                                        echo "checked";
                                                    } ?> name="food_3" id="food_3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">ร้อยละ 0-25 ของครัวเรือนที่ดำเนินการ</label>
                                                </div>
                                                <div class="flex item-left">
                                                    <input type="radio" value="20" <?php if ($data['food_3'] == "20") {
                                                        echo "checked";
                                                    } ?> name="food_3" id="food_3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                ...
                                                <div class="flex item-left">
                                                    <input type="radio" value="30" <?php if ($data['food_3'] == "30") {
                                                        echo "checked";
                                                    } ?> name="food_3" id="food_3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                ...
                                                <div class="flex item-left">
                                                    <input type="radio" value="40" <?php if ($data['food_3'] == "40") {
                                                        echo "checked";
                                                    } ?> name="food_3" id="food_3" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                        ...
                                        <tr>
                                            <td></td>
                                            <td>4.มีการขับเคลื่อนการขยายผลโครงการ 
...
นำเสนอ
                                            ...
                                            <td>
                                                <div class="flex item-left mb-4">
                                                    <input type="radio" value="10" <?php if ($data['food_4'] == "0") {
                                                        echo "checked";
                                                    } ?> name="food_4" id="food_4" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">ไม่มีการจัดศูนย์การเรียนรู้</label>
                                                </div>
                                                <div class="flex item-left">
                                                    <input type="radio" value="30" <?php if ($data['food_4'] == "30") {
                                                        echo "checked";
                                                    } ?> name="food_4" id="food_4" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300  ">
                                                    <label
                                                        class="ms-2 text-sm font-medium dark:text-gray-300">จัดให้มีศูนย์เรียนรู้ในที่ว่าการอำเภอ/จัดให้มีศูนย์เรียนรู้ ณ หน่วยงาน/องค์การอื่น
                                                    </label>
                                                </div>
