        ...
        <div class="card">
          <div class="card-body md:text-xl text-xl font-medium text-center">
            ...
            <h4 class="text-center text-1xl font-bold">
              <?= $title ?> จังหวัด
              <?= $province[@$_REQUEST["pcode"]]; ?>
            </h4><br>
            <table id="example" class="table table-striped table-responsive " style="text-align: center; border: #000000; width: 100%;">
              <thead>
                <tr>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=1_1"><button
                        type="submit"
                ...
                <tr>
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=1_2"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-left">1.มีสิ่งอำนวยความสะดวกทางกายภาพที่คำนึงถึงผู้พิการและผู้สูงอาุ เช่น
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=2_1"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr><!-- comment -->
                <tr>
                  <td></td>
                  <td class="text-left">2. มีการแสดงแผนผังขั้นตอนการให้บริการ
                  </td>
                  <td>
                      <?php
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=2_2"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr>
                <tr>
                  <td></td>
                  <td class="text-left">3. มีการแสดงแผนผังอำเภอและป้ายบอกทางภายในอาคาร</td>
                  <td>
                      <?php
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=2_3"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-left">1.มีการบำรุงดูแลรักษาตัวอาคารที่ว่าการอำเภอให้สะอาดเรียบร้อย สวยงาม
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=3_1"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr><!-- comment -->
                <tr>
                  <td></td>
                  <td class="text-left">2.มีการปรับปรุงรักษาสิ่งก่อสร้างหรือถาวรวัตถุ
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=3_2"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="text-left">1. กำหนดให้มีการปฏิบัติกิจกรรมโดยเฉพาะ สะสาง สะดวก สะอาดอย่างต่อเนื่อง
                  </td>
                  <td>
                      <?php
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=4_1"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr><!-- comment -->
                <tr>
                  <td></td>
                  <td class="text-left">2. แต่งตั้งคณะกรรมการติดตามผลการดำเนินกิจกรรม 5ส เพื่อรักษามาตรฐาน</td>
                  <td>
                      <?php
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=4_2"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr>
                <tr>
                  <td class=" " style="vertical-align: top;">5. สร้างวินัย</td>
                  <td class="text-left">1.จัดกิจกรรมส่งเสริมกิจกรรม 5ส เช่น การประกวดพื้นที่และมอบรางวัล
                  </td>
                  <td>
                      <?php
                  ...
                  <td><a
                      href="5s_upload5s.php?pcode=<?= @$user['pcode']; ?>&acode=<?= @$user['acode']; ?>&aname=<?= @$user['aname']; ?>&pname=<?= @$user['pname']; ?>&assessment=5_1"><button
                        type="submit"
                        class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">อัพโหลด</button></a>
                  </td>
                </tr>
