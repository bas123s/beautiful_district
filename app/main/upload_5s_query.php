...
$mc->table_name = "files_5s"; //กำหนดชื่อตารางที่จะบันทึกข้อมูล
...
foreach ($_FILES as $key => $value) {
	if($value['name']!=""){
	    ...
	    $fileDestination = "../../uploads/upload_5s/".$fileNameNew;
...
$link = "upload_5s.php?a=บันทึกสำเร็จ&pcode=" . $_POST['pcode'] . "&acode=" . $_POST['acode'] . "";
