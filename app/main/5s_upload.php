      ...
      <div class="card  " style="  text-align: center;   ">
        ...
        <div class="card">
          <div class="card-body md:text-xl text-xl font-medium text-center">
            ...
            <form action="support_upload.php" method="post" enctype="multipart/form-data">
              ...
              <div
                ...
                <div>
                  <div id="preview-container" class="mb-4 flex justify-center" hidden>
                    <?php
                    $filePath = '../../uploads/upload_sup/'. @$_REQUEST["assessment"] .@$_REQUEST["acode"] . "before.jpg";
                ...
                <div>
                  <div id="preview-container1" class="mb-4 flex justify-center" hidden>
                    <?php
                    $filePath = '../../uploads/upload_sup/' . @$_REQUEST["assessment"] . @$_REQUEST["acode"] . "after.jpg";
                    if (file_exists($filePath)) {
                      ?>
