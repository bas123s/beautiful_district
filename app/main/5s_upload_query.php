...
$mc->table_name = "file_5s"; //กำหนดชื่อตารางที่จะบันทึกข้อมูล
...
if ($fileError === 0) {
  ...
  $fileDestination = "../../uploads/upload_5s/" . $fileName;
...
if ($fileError_after === 0) {
  // กำหนดโฟลเดอร์ที่จะเก็บไฟล์
  $fileDestination_after = "../../uploads/upload_5s/" . $fileName_after;
...
$link = "rpt_5s_amp_upload.php?a=บันทึกสำเร็จ&pcode=" . $_POST['pcode'] . "&aname=" . $_POST['aname'] . "";
