...
<section class="relative  md:py-24 py-16">
    <div class="container mx-auto px-4  relative">
        ...
        <div class="card-body md:text-xl text-xl font-medium text-center">
            ...
            <a href="#" 
                                            class="btn btn-warning  md:text-2xl text-2xl text-white font-bold py-2 px-4 border-b-4rounded">แบบฟอร์มการประเมิณ </a>
            </div>
                ...
                <tbody>
                    ...
                    foreach (@$data as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?= $value['aname']; ?></td>
                            <td>
                                <form id ="form_main_5s_<?= $i; ?>" method="post" name="form_main_5s" action="form_five.php">
                                    <button type="submit"
                                            class="btn btn-primary  md:text-2xl text-2xl text-white font-bold py-2 px-4 border-b-4rounded">กรอกแบบประเมิน </button>
