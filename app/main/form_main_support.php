...
<section class="relative  md:py-24 py-16">
    <div class="container mx-auto px-4  relative">
        ...
        <div class="card-body md:text-xl text-xl font-medium text-center">
            ...
            <h2 class=" text-center md:text-xl text-xl font-medium ">หัวข้อการประเมินหลัก  4. อำเภอมีสภาพในการเป็นศูนย์เรียนรู้</h2>
                ...
                <tbody>
                    ...
                    foreach (@$data as $key => $value) {
                        ...
                        <tr>
                            ...
                            <td><?= $value['aname']; ?></td>
                            <td>
                                <form id ="form_main_support_<?= $i; ?>" method="post" name="form_main_support" action="form_support.php">
                                    <button type="submit"
