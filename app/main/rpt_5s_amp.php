<?php
$title = 'เกณฑ์การประเมิน หัวข้อการประเมินหลัก 3. การจัดการความเรียบร้อยของที่ทำการปกครองอำเภอ (5 ส.) และการอำนวยความสะดวกแก่ประชาชน"';
            ...
            <table id="example" class="table-bordered table-responsive" style="text-align: center; border: #000000;">
              <thead>
                <tr>
                  ...
                  <th colspan="2">การสะสาง</th>
                  <th colspan="2">ความสะดวก</th>
                  <th colspan="2">ความสะอาด</th>
                  <th colspan="2">การสร้างมาตรฐาน</th>
                  <th colspan="2">การสร้างวินัย</th>
              ...
              <tbody>
                ...
                foreach (@$data as $key => $value) {
                  ...
                  <tr>
                    ...
                    <td><a href="5s_pdf.php?acode=<?= @$value['acode']; ?>&aname=<?= @$value['aname']; ?>&pname=<?= @$value['pname']; ?>"><button type="submit" class="btn btn-primary  md:text-xl text-xl text-white  py-2 px-4 border-b-4rounded">พิมพ์แบบประเมิน</button></a></td>
                  </tr>
                <?php } ?>
