...
$sql = "SELECT * FROM `beautiful_district`.`view_assessment_support_a` WHERE `acode` = '" . @($_REQUEST['acode']) . "'";
    ...
    <html>
        ...
        <body>
            ...
            <div>
                ...
                <h4 style="font-size: 16pt; text-align: center; font:bold"> หัวข้อการประเมินหลัก 4. อำเภอมีสภาพในการเป็นศูนย์การเรียนรู้</h4>
                ...
                <table >
                    ...
                    <tbody>
                        <tr>
                            ...
                            @$sum_all = 0;
                            @$sum_all = @$data['home']  + @$data['clothes']  + @$data['support'];
                            ?>

                            <td style="width: 8%;">1</td>
                            <td style="width: 70%;text-align: left; padding-left: 10px;" >บ้านนี้มีรักปลูกผักกินเอง/ทางนี้มีผล ผู้คนรักกัน</td>
                            <td>60</td>
                            <td class="px-4 py-2 text-right"> <?= @$data['home']; ?></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>20</td>
                            <td class="px-4 py-2 text-right"> <?= @$data['clothes']; ?></td>
                        </tr>
