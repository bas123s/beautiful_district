    ...
    <div class="container mx-auto px-4  relative">
        <div class="grid grid-cols-1 lg:grid-cols-1 md:grid-cols-1 gap-[30px]">
            <div class="card container  " style="  text-align: center;   ">
                <form id ="search_dopa" name="search_dopa" action="form_org.php">
            ...
            <div class="card"   style="  text-align: center;   ">
                <div class="card-body md:text-xl text-xl font-medium text-center">
                    <form method="post" action="form_org_query.php">
                        ...
                        <table id="example" class="table-bordered table-responsive" style="  text-align: center;   ">
                            ...
                            <tbody>
                                <tr>
                                    <?php
                                    $i = 1;
                                    $css = "appearance-none block w-full bg-gray-200 text-gray-700 border border-indigo-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white";
                                    $input_option = ' min="0" max="30" step="1" ';
                                    $input_option2 = ' min="0" max="40" step="1" ';
                                    foreach (@$data as $key => $value) {
                                        ...
                                        <?php if ($user['pid'] == "0305") { ?>
                                            <td>40</td>
                                            <td class="px-4 py-2 text-right"><input name="gecc[<?= @$value['id']; ?>]" class="<?= $css; ?>" <?= $input_option2 ?> type='number' value='<?= @$value['gecc']; ?>'></td>
                                        <?php } else if ($user['pid'] == "0322") { ?>
                                            <td>30</td>
